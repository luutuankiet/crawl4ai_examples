# Single record chart parameters for LookML dashboards  |  Looker  |  Google Cloud

**Source:** https://cloud.google.com/looker/docs/reference/param-lookml-dashboard-singe-record-chart
...
Was this helpful?
Send feedback 
#  Single record chart parameters for LookML dashboards
...
> **Under Construction:** We're working on adding more to this page. In the meantime, check out the Single record chart options documentation page to view information about creating and editing single value visualizations using the visualization option menu.
The parameters described on this page are for use with LookML dashboard elements of `type: looker_single_record` in a `dashboard.lkml` file.
For information about building a single record chart through the Looker UI, see the Single record chart options documentation page.
## Basic parameters
...
## Single record parameters
This section describes the LookML equivalents of the options in the **Edit** menu for single record charts.
### `show_view_names`

# Line chart parameters for LookML dashboards  |  Looker  |  Google Cloud
...
## Series parameters
The parameters described in this section correspond to the options in the **Series** section of the visualization editor for line charts.
### `colors`

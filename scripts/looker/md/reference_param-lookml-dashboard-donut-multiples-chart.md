# Donut multiples chart parameters for LookML dashboards  |  Looker  |  Google Cloud

**Source:** https://cloud.google.com/looker/docs/reference/param-lookml-dashboard-donut-multiples-chart
...
Changes the font size of series labels  
Specifies the number of donut charts per row  

# Scheduled Plans for Look  |  Looker  |  Google Cloud

**Source:** https://cloud.google.com/looker/docs/reference/looker-api/latest/methods/ScheduledPlan/scheduled_plans_for_look
...
## Request
GET /scheduled_plans/look/{look_id} 
Datatype
Description
Request
HTTP Request 

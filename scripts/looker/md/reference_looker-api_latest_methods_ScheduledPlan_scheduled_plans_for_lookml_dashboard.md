# Scheduled Plans for LookML Dashboard  |  Looker  |  Google Cloud

**Source:** https://cloud.google.com/looker/docs/reference/looker-api/latest/methods/ScheduledPlan/scheduled_plans_for_lookml_dashboard
...
## Request
GET /scheduled_plans/lookml_dashboard/{lookml_dashboard_id} 
Datatype
Description
Request
HTTP Request 

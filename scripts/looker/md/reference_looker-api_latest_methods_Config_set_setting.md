# Set Setting  |  Looker  |  Google Cloud

**Source:** https://cloud.google.com/looker/docs/reference/looker-api/latest/methods/Config/set_setting
...
body
Looker Setting Configuration
Expand Setting definition... 
instance_config
_lock_
